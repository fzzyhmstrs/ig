...
open class CelestialTridentEntity : PersistentProjectileEntity {
    ...
    constructor(entityType: EntityType<out CelestialTridentEntity?>?,world: World?, owner: LivingEntity?, stack: ItemStack) : super(
        entityType,
        owner,
        world
    ) {
    ...
    protected var tridentStack = ItemStack(RegisterTool.CELESTIAL_TRIDENT)
    ...
    companion object {
        private val LOYALTY = DataTracker.registerData(CelestialTridentEntity::class.java, TrackedDataHandlerRegistry.BYTE)
        private val ENCHANTED =
            DataTracker.registerData(CelestialTridentEntity::class.java, TrackedDataHandlerRegistry.BOOLEAN)
    }
}