...
open class ModifiableArmorItem(private val fzzyMaterial: FzzyArmorMaterial, slot: Type, settings: Settings): ArmorItem(fzzyMaterial,slot,settings), Reagent, Modifiable {
