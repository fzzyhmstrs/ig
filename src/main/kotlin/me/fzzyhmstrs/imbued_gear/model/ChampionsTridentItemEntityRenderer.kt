...
import me.fzzyhmstrs.imbued_gear.model.ChampionsTridentEntityModel.Companion.TEXTURE
...
object ChampionsTridentItemEntityRenderer: BuiltinItemRendererRegistry.DynamicItemRenderer {

    private val modelLoader by lazy {
        ItemModelRegistry.getEntityModelLoader(RegisterItem.CHAMPIONS_TRIDENT)
    }
