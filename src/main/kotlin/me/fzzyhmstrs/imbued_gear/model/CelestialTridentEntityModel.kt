...
class CelestialTridentEntityModel(private val root: ModelPart) : TridentEntityModel(root) {
    ...
    companion object {
        ...
        fun getTexturedModelData(): TexturedModelData {
            ...
            modelPartData2.addChild(
                "left_spike",
                ModelPartBuilder.create().uv(4, 3).cuboid(-2.5f, -3.0f, -0.5f, 1.0f, 6.0f, 1.0f),
                ModelTransform.NONE
            )
            modelPartData2.addChild(
                "middle_spike",
            ...
            modelPartData2.addChild(
                "right_spike",
                ModelPartBuilder.create().uv(4, 3).mirrored().cuboid(1.5f, -3.0f, -0.5f, 1.0f, 6.0f, 1.0f),
                ModelTransform.NONE
            )
